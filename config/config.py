...
crack = {
    ...
    'aspect_ratios': [[3.49], [5.76, 10.89], [14.44, 10.89], [2, 3], [2], [2]],#[[1/0.49], [1/0.16,1/0.09], [1/0.16,1/0.09], [1/0.16,1/0.09], [1/0.09], [1/0.09]],
    'variance': [0.1, 0.2],
    'clip': True,
    'name': 'CRACK',
    'work_name':"SSD300_CRACK_FPN_GIOU_Anchor",
}
